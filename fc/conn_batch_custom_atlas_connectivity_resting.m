function conn_batch_custom_atlas_connectivity_resting(params_file)
...
% ROIs
batch.Setup.rois.files{1} = fullfile(params.dependencies,'rois','craddock200_91_109_91.nii'); % Craddock200 atlas
...
extract_craddock200_fc_ts(params_file,batch.filename,analysis_name)
