function conn_batch_connectivity_resting_moderate(params_file)
...
% Results directory
res_dir = fullfile(params.target,'results','conn_resting'); % results directory
mkdir(res_dir)
...
% ROIs
batch.Setup.rois.files{1} = fullfile(params.dependencies,'rois','AAL116.nii'); % AAL atlas
...
batch.Denoising.confounds.names = {'White','CSF','realignment'};
batch.Denoising.confounds.dimensions = {1,1,6};
batch.Denoising.confounds.deriv = {0,0,0};
